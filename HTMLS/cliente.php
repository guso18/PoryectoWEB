...
<body>
    ...
    <div class="container my-5">
        <h2 id="catalogo" class="text-center mb-4">Catálogo de Servicios</h2>
        <div class="row">
            <div class="col-md-4">
                <div class="card">
    ...
    <!-- Sección de Opiniones y Valoraciones --> 
     <div class="container my-5"> 
        <h2 class="text-center mb-4">Opiniones y Valoraciones</h2>
        <h5 class="text-center my-4">Porque tu opinión es importante para nosotros.</h5> 
        <div class="text-center"> 
            <a href="opiniones.php" class="btn btn-primary">Deja tu Opinión</a> 
        </div> 
    </div>
